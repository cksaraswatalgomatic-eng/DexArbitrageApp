...
- `POST /api/reports/gas-ops`: accepts optional `{ hours, limit }` and returns gas balance summaries, consumption timeline, and recent tracking entries for the Gas & Ops tab.
